...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    summary:
      'เว็บส่งเสริมการขายของแบรนด์คาแรกเตอร์ Gloobies ในรูปมินิเกมแบบทดสอบบุคลิกภาพ MBTI เล่นจบแล้วได้รู้ว่าน้องกลูบี้ตัวไหนเข้ากับตัวเองที่สุด',
    problem:
      'แบรนด์อยากให้คนรู้จักน้องกลูบี้ทั้ง 17 ตัวและอยากรับน้องกลับบ้าน ซึ่งหน้าแคตตาล็อกธรรมดาทำได้แค่ให้เลื่อนผ่าน ต้องมีอะไรที่สนุกพอให้คนเล่นจนจบ ผูกพันกับคาแรกเตอร์ และอยากส่งผลลัพธ์ต่อให้เพื่อน',
    solution:
