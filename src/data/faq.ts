...
export const faqs: FAQItem[] = [
  {
    ...
    answer:
      'ส่วนใหญ่จะเป็น fixed price หลังคุยขอบเขตงานชัดเจน เพื่อให้ลูกค้าวางแผนงบประมาณได้ง่าย ในกรณีงานที่ scope เปลี่ยนเร็วหรือเป็น maintenance จะเป็นรายชั่วโมงหรือ retainer',
    category: 'pricing',
  },
  {
    id: 'payment',
    ...
    answer:
      'แบ่งเป็น 2-3 งวด ขึ้นกับขนาดงาน — โดยทั่วไป 50% เริ่มงาน, 50% ส่งงาน สำหรับโปรเจกต์ใหญ่จะแบ่งเป็น 30/40/30 ตาม milestone',
    category: 'pricing',
  },
  {
    id: 'timeline',
    ...
    answer:
      'UI/UX 2-3 สัปดาห์, Frontend dev 3-5 สัปดาห์, Full-Stack 6-10 สัปดาห์ — ขึ้นกับ scope จริงและการตอบกลับจากฝั่งลูกค้า',
    category: 'process',
  },
  {
    id: 'revisions',
  ...
  },
  {
    ...
    answer:
      'ได้ครับ เลือก package UI/UX ได้เลย จะส่ง design + handoff document ให้ทีม dev ของลูกค้านำไปสร้างต่อ',
    category: 'general',
  },
  {
    id: 'maintenance',
    ...
    answer:
      'มี — รับประกันแก้ bug ฟรี 30 วันหลังส่งงาน, หลังจากนั้นรับเป็น retainer รายเดือนหรือคิดตามงาน',
    category: 'general',
  },
];
