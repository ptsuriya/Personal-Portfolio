const services = [
  {
    icon: "🎨",
    title: "UI/UX Design",
    desc: "ออกแบบ wireframe, prototype, design system",
    price: "เริ่มต้น ฿—",
    tags: ["Figma", "Penpot"],
  },
  {
    icon: "⚡",
    title: "Frontend Dev",
    desc: "พัฒนาเว็บด้วย Next.js / React",
    price: "เริ่มต้น ฿—",
  ...
  },
  {
    ...
    desc: "ออกแบบ + พัฒนา + deploy ครบวงจร",
    price: "เริ่มต้น ฿—",
    tags: ["Next.js", "Laravel", "Figma"],
  },
];

export default function CodeworkPricingPage() {
  return (
    <main className="mx-auto max-w-4xl px-6 py-12">
      <div className="mb-10">
        <p className="mb-1 text-[10px] font-semibold uppercase tracking-[0.28em] text-[#C86858]">Pricing</p>
        <h1 className="text-3xl font-bold text-[#2A1010]">ราคา</h1>
        <p className="mt-2 text-sm text-[#9A6858]">ราคาเริ่มต้น — ราคาจริงขึ้นอยู่กับขอบเขตงาน</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
        {services.map((s) => (
          <div
            key={s.title}
            className="flex flex-col gap-4 rounded-2xl border border-[#E8B8A8]/60 bg-[#FAE4DC]/60 p-6 backdrop-blur-sm"
          >
      ...
      <div className="mt-10 rounded-2xl border border-[#E8B8A8]/50 bg-[#FAE4DC]/60 p-6 text-center">
        <p className="mb-2 text-sm text-[#9A6858]">ทักมาคุยก่อนได้เลย ไม่มีค่าใช้จ่าย</p>
