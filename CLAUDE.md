...
- **ช่องทางติดต่อ**: อีเมลและฟอร์มเท่านั้น (`contact@kumadesign.dev` ส่งต่อเข้า `ptsuriyarangsri@gmail.com` ผ่าน Cloudflare Email Routing) — **ไม่มี LINE** ห้ามใส่กลับมา
